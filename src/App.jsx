  ...
  if (!isConfigured) {
    return (
      <main className="app-container" style={{ alignItems: 'center', justifyContent: 'center', minHeight: '80vh' }}>
        <section className="glass-card" style={{ maxWidth: '500px', width: '100%' }} aria-labelledby="config-title">
    ...
    <div className="app-container">
      ...
      <main className="triage-grid">
        <section className="glass-card" aria-label="Data Input Section">
          ...
          <label htmlFor="emergency-input" className="sr-only" style={{display: 'none'}}>Emergency input field</label>
          <input 
            type="file" 
            ref={fileInputRef} 
